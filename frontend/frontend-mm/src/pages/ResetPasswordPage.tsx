...
export function ResetPasswordPage() {
  ...
  const onRequestOtp = async (event: FormEvent) => {
    ...
    try {
      ...
      showToast(extractApiError(err, 'Unable to send OTP. Please verify mobile number and try again.'), 'error')
    }
  }
  ...
  const onVerifyOtp = async (event: FormEvent) => {
    ...
    try {
      ...
      showToast(extractApiError(err, 'OTP verification failed. Please try again.'), 'error')
    }
  }
  ...
  const onResetPassword = async (event: FormEvent) => {
    ...
    try {
      ...
      showToast(extractApiError(err, 'Password reset failed. Please try again.'), 'error')
    }
  }
